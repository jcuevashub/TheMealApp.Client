import {
  ...
  transition,
  trigger
} from "./chunk-6XMBCRMJ.js";
import {
  DomSanitizer
} from "./chunk-N4LCOABE.js";
...
NgxSpinnerComponent.ɵfac = function NgxSpinnerComponent_Factory(t) {
  return new (t || NgxSpinnerComponent)(ɵɵdirectiveInject(NgxSpinnerService), ɵɵdirectiveInject(ChangeDetectorRef), ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(NGX_SPINNER_CONFIG, 8));
};
NgxSpinnerComponent.ɵcmp = ɵɵdefineComponent({
  ...
  hostBindings: function NgxSpinnerComponent_HostBindings(rf, ctx) {
    if (rf & 1) {
      ɵɵlistener("keydown", function NgxSpinnerComponent_keydown_HostBindingHandler($event) {
...
NgxSpinnerModule.ɵmod = ɵɵdefineNgModule({
  type: NgxSpinnerModule,
  declarations: [NgxSpinnerComponent, SafeHtmlPipe],
  imports: [CommonModule],
  exports: [NgxSpinnerComponent]
});
NgxSpinnerModule.ɵinj = ɵɵdefineInjector({
  imports: [CommonModule]
});
(() => {
